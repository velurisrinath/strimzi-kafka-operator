...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(name = KafkaListenerAuthenticationKubernetesServiceAccounts.KUBERNETES_SA, value = KafkaListenerAuthenticationKubernetesServiceAccounts.class),
})
